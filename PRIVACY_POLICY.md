...
- Connect to the internet for any purpose
- Use analytics, crash reporting, or any third-party SDKs that collect user data
- Require account registration or login
- Track usage, behavior, or location
...
The app does not transmit, upload, or share these files. All export operations are local only.
...
Unlike the mobile version, the desktop app does not include GPS location resolution or Simply Plural / PluralKit import features. There are therefore no outbound network requests of any kind.
...
If this policy changes, the updated version will be available in this repository. Continued use of the app after changes constitutes acceptance.
